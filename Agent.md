...
- **App strict concurrency:** `SWIFT_STRICT_CONCURRENCY = complete` on the `MusicWall` app target only (Phase 3). Test targets get complete strict-concurrency checking implicitly via Swift 6 language mode (Phase 4).
